...
def send_start(bot, update):
    ...
    keyboard += [[InlineKeyboardButton(text="🌐Connect Group",callback_data="main_connect"),InlineKeyboardButton(text="Grup Support💭",url="https://t.me/KingUserbotSupport))]]
    keyboard += [[InlineKeyboardButton(text="➕ Tambahkan Ke Group ➕",url="t.me/{}?startgroup=true".format(bot.username))]]
